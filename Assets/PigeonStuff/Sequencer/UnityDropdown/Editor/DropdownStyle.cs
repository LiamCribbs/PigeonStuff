namespace UnityDropdown.Editor
{
    ...
    internal static class DropdownStyle
    {
        ...
        private static readonly Color HighlightedColorDarkSkin = new Color(0.7607843f, 0.3411765f, 1f, 0.2f);
        private static readonly Color HighlightedColorLightSkin = new Color(0.7607843f, 0.3411765f, 1f, 0.2f);

        private static readonly Color SelectedColorDarkSkin = new Color(0.7607843f, 0.3411765f, 1f, 0.5f);
        private static readonly Color SelectedColorLightSkin = new Color(0.7607843f, 0.3411765f, 1f, 0.5f);
