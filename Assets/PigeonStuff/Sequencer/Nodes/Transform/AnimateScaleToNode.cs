...
{
    /// <summary>
    /// Animate an object's scale from its current value to a target
    /// </summary>
    [SerializedNode("Transform/Animate Scale To")]
    public class AnimateScaleToNode : Node
    {
        ...
        public override string Description => "Animate a transform's scale to a value";
