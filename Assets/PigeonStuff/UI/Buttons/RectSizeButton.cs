...
namespace Pigeon.UI
{
    public class RectSizeButton : Button
    {
        ...
        public virtual Vector2 GetDefaultSize() => defaultSize;
        ...
        protected virtual IEnumerator AnimateThickness(Vector2 targetSize, float speed, EaseFunctions.EvaluateMode ease)
        {
