...
namespace Pigeon.Math
{
    ...
    public struct Random
    {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Color NextColorHSV(float hMin, float hMax, float sMin, float sMax, float vMin, float vMax)
        {
            return Color.HSVToRGB(NextFloat(hMin, hMax), NextFloat(sMin, sMax), NextFloat(vMin, vMax));
        }
